...
The only thing you need to be aware of is that mods for MelonLoader now need to be installed into the `MLLoader` subfolders. See the [Installing mods](#installing-mods) section below for details.
